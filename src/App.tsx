...
const Logo = ({ className }: { className?: string }) => (
  <a href="#" className={cn("flex items-center gap-2 sm:gap-3", className)}>
    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-white flex items-center justify-center overflow-hidden shadow-2xl">
      <span className="font-heading font-semibold text-black text-sm sm:text-base italic" style={{ fontFamily: "'Instrument Serif', serif" }}>TN</span>
    </div>
    <div className="flex flex-col leading-none">
      <span className="font-body font-bold text-white text-lg sm:text-xl tracking-tight">Taban Ngunar</span>
      <span className="font-body font-light text-white/50 text-[7px] sm:text-[9px] uppercase tracking-[0.3em]">Data · Cloud · Impact</span>
    </div>
  </a>
);
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="liquid-glass rounded-full px-2 py-1.5 flex items-center gap-1">
          ...
          <div className="flex items-center gap-1">
            <Button variant="solid" icon={ArrowUpRight} href="#contact" className="hidden sm:flex">Get in Touch</Button>
            <button
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <Button variant="solid" icon={ArrowUpRight} href="#contact" className="w-full py-4">Get in Touch</Button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        >
          <Badge className="flex items-center gap-2">
            <span className="bg-white text-black px-1.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider">Est. 2026</span>
            <span>Data Scientist &amp; Cloud Engineer · Refugee Tech Advocate</span>
          </Badge>
        </motion.div>
        ...
        >
          Making data work for humanity with Python, AWS, Power BI, and open-source tools.
        </motion.p>
        ...
        >
          <Button variant="liquid-strong" className="px-8 py-4 text-base" icon={ArrowUpRight} href="#projects">View Projects</Button>
          <Button variant="liquid" className="px-8 py-4 text-base" href="#about">About Me</Button>
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
            {["Python", "AWS", "Power BI", "SQL", "Open Source"].map((tool) => (
              <span key={tool} className="text-2xl md:text-3xl font-heading text-white">
                {tool}
              </span>
            ))}
          </div>
  ...
  return (
    <section className="relative min-h-[700px] w-full py-32 px-6 md:px-16 lg:px-24 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl">
        ...
        <SectionHeading className="mt-4">Data has changed. Have you?</SectionHeading>
        <p className="font-body font-light text-white/60 text-lg mt-6">
          As a Data Scientist &amp; Cloud Engineer, I help organizations and communities navigate the
          complex landscape of digital transformation and data-driven impact.
        </p>
        <div className="flex justify-center mt-10">
          <Button variant="liquid-strong" className="px-8" icon={ArrowUpRight} href="#projects">See the Work</Button>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section className="py-24 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
      <div className="mb-20">
        ...
        <SectionHeading className="mt-4">Solutions for impactful technology.</SectionHeading>
      </div>
      ...
      <div className="space-y-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 space-y-6 text-center lg:text-left">
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-heading text-white leading-tight">Building Robust Data Pipelines</h3>
            <p className="text-white/60 font-body font-light leading-relaxed max-w-2xl mx-auto lg:mx-0">
              I build robust data pipelines and machine learning models with Python, turning raw,
              messy data into clean, reliable foundations that organizations can actually trust
              and act on.
            </p>
            <div className="flex justify-center lg:justify-start">
              <Button variant="liquid-strong" href="#projects">Explore Projects</Button>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          <div className="flex-1 space-y-6">
            <h3 className="text-3xl md:text-4xl font-heading text-white">Architecting Scalable Cloud Solutions</h3>
            <p className="text-white/60 font-body font-light leading-relaxed">
              I architect secure, scalable cloud infrastructure on AWS and open-source technologies —
              built for global impact, not just a single deployment.
            </p>
            <Button variant="liquid-strong" href="#about">Read My Story</Button>
          </div>
  ...
  const cards = [
    {
      icon: Database,
      title: "Data Science",
      description: "Transforming raw data into meaningful insights for social and business impact."
    },
    {
      icon: Cloud,
      title: "Cloud Engineering",
      description: "Architecting secure and scalable cloud infrastructure using AWS and open-source technologies."
    },
    {
      icon: HeartHandshake,
      title: "Refugee Tech",
      description: "Advocating for digital empowerment and technology access for displaced and underserved communities."
    },
    {
      icon: Code2,
      title: "Open Source",
      description: "Contributing to and leveraging open-source tools to create practical humanitarian and community-focused solutions."
    }
  ];

  return (
    <section id="expertise" className="py-24 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
      <div className="mb-16">
  ...
  const journey = [
    {
      ...
      description: "Empowering individuals with the tools and knowledge needed to thrive in a digital-first world."
    },
    {
      title: "AI & Data Engineering",
      description: "Specializing in the architecture and implementation of intelligent data systems and technology solutions."
    },
    {
      title: "Refugee Tech Advocate",
      description: "Championing digital inclusion, technology access, and digital empowerment for marginalized and displaced populations."
    },
    {
      title: "Data Science Development",
      description: "Building impact-driven data science projects that use technology and data to address real-world problems."
    }
  ];

  return (
    <section id="about" className="py-24 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
      <div className="mb-16 max-w-3xl">
        <Badge>About Me</Badge>
        <SectionHeading className="mt-4">A journey of purpose and technology.</SectionHeading>
        <p className="text-white/60 font-body font-light text-lg mt-6 leading-relaxed">
          I am a Data Scientist and Cloud Engineer dedicated to transforming lives through digital
          empowerment. My work sits at the intersection of advanced analytics, technology, and
          humanitarian advocacy.
        </p>
        <p className="text-white/60 font-body font-light text-lg mt-4 leading-relaxed">
          As a Refugee Tech Advocate, I understand the profound impact that access to technology and
          digital skills can have on displaced communities. My journey is driven by the belief that
          data, when used ethically and creatively, can be a powerful force for humanity.
        </p>
      </div>
    ...
    <section className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="liquid-glass rounded-3xl p-12 md:p-20 backdrop-blur-3xl">
          <Badge>Mission</Badge>
          <p className="font-heading text-2xl md:text-4xl text-white leading-snug mt-4" style={{ fontFamily: "'Instrument Serif', serif" }}>
            "I'm building a future where technology meets humanity — where data finds purpose,
            communities find reach, and every digital tool becomes a catalyst for change."
          </p>
          <p className="text-white/60 font-body font-light text-base mt-8 leading-relaxed max-w-2xl mx-auto">
            A journey where data science, cloud engineering, and social impact flow together — with
  ...
  const projects = [
    {
      ...
      description: "A comprehensive analysis of motor vehicle theft patterns in New Zealand using SQL databases, identifying key trends, recovery rates, and geographic distributions to support law enforcement strategies and public safety initiatives.",
      tech: ["SQL", "Data Analysis", "Public Safety"],
      github: "https://github.com/bielng/motor-vehicle-thefts-analysis-in-new-zealand"
    },
    {
      title: "Linear Regression Model Validation",
      category: "Computer Pricing Analysis · Statistical Modeling",
      description: "An end-to-end linear regression analysis focused on computer pricing, with comprehensive validation of model assumptions — residual analysis, multicollinearity detection, model evaluation, and optimization.",
    ...
    },
    {
      ...
      description: "A predictive analysis of customer churn for a music streaming platform, examining user engagement and behavioral patterns, including the relationship between discounts, music preferences, and community engagement.",
      tech: ["Predictive Analytics", "Churn Analysis", "Business Insights"],
      github: "https://github.com/bielng/Maven_Music_Customer_Churn_Analysis_Project"
    },
    {
      title: "Movie Ratings Data Cleaning & EDA",
      category: "Entertainment Industry · Data Preprocessing",
      description: "A comprehensive data cleaning and exploratory data analysis project on a movie ratings dataset — applying preprocessing techniques, handling missing values, and uncovering patterns in ratings and preferences.",
    ...
    },
    {
      ...
      description: "A complete data processing pipeline demonstrating an end-to-end data preparation workflow — focused on transformation, feature engineering, quality assurance, and preparing datasets for machine learning.",
      tech: ["Automation", "ETL", "Data Engineering"],
      github: "https://github.com/bielng/Data-Cleaning-and-Transformation-Project"
    }
  ];

  return (
    <section id="projects" className="py-24 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
      <div className="mb-16">
        <Badge>Projects</Badge>
        <SectionHeading className="mt-4">Real-world applications and case studies.</SectionHeading>
        <p className="text-white/60 font-body font-light text-lg mt-6 max-w-2xl leading-relaxed">
          Explore my portfolio of data science projects showcasing analytical skills, machine
          learning expertise, and business impact through data-driven insights.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((project, i) => (
          ...
          >
            <div>
              <p className="text-white/40 text-[10px] uppercase tracking-widest mb-3">{project.category}</p>
              <h4 className="text-2xl font-heading text-white mb-4">{project.title}</h4>
              <p className="text-white/60 font-body font-light text-sm leading-relaxed mb-6">
                {project.description}
              </p>
              <div className="flex flex-wrap gap-2 mb-8">
                {project.tech.map((t) => (
                  <span key={t} className="liquid-glass-strong rounded-full px-3 py-1 text-[10px] text-white/70 uppercase tracking-wider">
                    {t}
                  </span>
                ))}
              </div>
        ...
        >
          <h4 className="text-2xl font-heading text-white mb-3">Let's collaborate on something meaningful.</h4>
          <p className="text-white/60 font-body font-light text-sm leading-relaxed mb-8">
            Have a project in mind, want to collaborate, or simply want to say hi? I'd love to hear from you.
          </p>
          <Button variant="solid" icon={ArrowUpRight} href="#contact">Get in Touch</Button>
        </motion.div>
      </div>
    </section>
  );
    ...
    <section id="contact" className="py-24 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-8">
          <div>
            <Badge>Contact</Badge>
            <SectionHeading className="mt-4">Let's start a conversation.</SectionHeading>
            <p className="text-white/60 font-body font-light text-lg mt-6 leading-relaxed">
              Whether you have a project in mind, want to collaborate, or simply want to say hi, I'd
              love to hear from you. I'm always open to discussing new opportunities, meaningful
              collaborations, and impactful ideas.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 group">
              ...
              <div>
                <div className="text-white/40 text-[10px] uppercase tracking-widest">Email Me</div>
                <div className="text-white font-body text-sm">ngunartaban@gmail.com</div>
              </div>
            </div>
            <div className="flex items-center gap-4 group">
              <div className="w-12 h-12 rounded-2xl liquid-glass flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <div>
                <div className="text-white/40 text-[10px] uppercase tracking-widest">LinkedIn</div>
                <a href="https://www.linkedin.com/in/taban-ngunar-x217/" target="_blank" rel="noopener noreferrer" className="text-white font-body text-sm hover:underline">
                  taban-ngunar-x217
                </a>
              </div>
            </div>
            <div className="flex items-center gap-4 group">
              ...
              <div>
                <div className="text-white/40 text-[10px] uppercase tracking-widest">GitHub</div>
                <a href="https://github.com/bielng" target="_blank" rel="noopener noreferrer" className="text-white font-body text-sm hover:underline">
                  bielng
                </a>
              </div>
            </div>
        ...
        <footer className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            {["Home", "About", "Projects", "Contact"].map((link) => (
              <a key={link} href={link === "Home" ? "#" : `#${link.toLowerCase()}`} className="text-white/40 hover:text-white text-xs font-body uppercase tracking-widest transition-colors">
                {link}
              </a>
            ))}
          </div>
